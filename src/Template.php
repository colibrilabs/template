...
class Template implements TemplateInterface
{
    ...
    public function __construct($directory, array $data = [])
    {
        ...
        $this->variables = new Collection($data);
        $this->sections = new Collection();
        
        $this->directories = new Collection([], Directory::class);
        $this->functions = new Collection([], null);
        $this->layouts = new Collection([], null);
